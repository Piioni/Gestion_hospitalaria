                            ...
                            <form action="" method="GET" class="filter-form">
                                    ...
                                    <div class="filter-field">
                                        ...
                                        <div class="form-field">
                                            <select name="tipo" id="tipo" class="form-select">
                                                ...
                                                <option value="GENERAL" <?= $filtro_tipo === 'GENERAL' ? 'selected' : '' ?>>
                                                    General
                                                </option>
                                                <option value="PLANTA" <?= $filtro_tipo === 'PLANTA' ? 'selected' : '' ?>>
                                                    Planta
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="filter-actions">
                                    ...
                                    <?php if ($filtro_hospital || $filtro_tipo || $filtro_almacen || $filtro_nombre): ?>
                                        <a href="<?= url('stocks.almacenes') ?>" class="btn btn-secondary"><i
                                        ...
                                        <div class="stock-section">
                                            ...
                                            <?php if (empty($productosEnStock)): ?>
                                                <div class="empty-stock">
                                                    ...
                                                    <a href="<?= url('movimientos.create', ['tipo' => 'entrada', 'id_almacen' => $almacen->getId()]) ?>"
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <?php foreach ($productosEnStock as $stock):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <!--TODO: Crear pactos y, si existe un pacto, mostrar el valor minimo de productos.-->
                                                                <td> 0</td>
                                                                <td class="actions-column">
                                                                    <div class="btn-container">
                                                                        ...
                                                                        <!-- TODO: Boton que permita crear un nuevo pacto. -->
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
