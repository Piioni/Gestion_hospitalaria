                            ...
                            <div class="card-body">
                                <div class="hospital-details">
                                    <div class="hospital-info">
                                        ...
                                        <p><strong>Dirección:</strong> <?= htmlspecialchars($hospital->getUbicacion()) ?></p>
                                    </div>
                                    ...
                                    <div class="hospital-actions">
                                        ...
                                        <a href="/plants/create?hospital_id=<?= $hospital->getIdHospital() ?>" class="btn btn-sm btn-primary">
                                            Añadir planta
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <?php foreach ($plantas as $planta): ?>
                                                <tr>
                                                    ...
                                                    <td class="actions-column">
                                                        <a href="/plants/edit?id=<?= $planta->getId() ?>" class="btn btn-sm btn-secondary">
                                                            Editar
                                                        </a>
                                                        <a href="/plants/view?id=<?= $planta->getId() ?>" class="btn btn-sm btn-info">
                                                            Ver stock
                                                        </a>
                                                    </td>
                                                </tr>
